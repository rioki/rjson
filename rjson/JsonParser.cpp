...
#line 142 "rjson/JsonParser.cpp" // lalr1.cc:479
  ...
  parser::parser (JsonLexer& lex_yyarg, rjson::Value& value_yyarg, std::ostream& err_yyarg, std::string filename_yyarg)
    :
#if YYDEBUG
      yydebug_ (false),
      yycdebug_ (&std::cerr),
...
#line 92 "rjson/JsonParser.ypp" // lalr1.cc:859
    {
        ...
        (yylhs.value.object)->insert(std::make_pair(key, *(yystack_[0].value.value)));
...
#line 99 "rjson/JsonParser.ypp" // lalr1.cc:859
    {
        ...
        (yylhs.value.object)->insert(std::make_pair(key, *(yystack_[2].value.value)));
...
#undef YYCASE_
  ...
  parser::yydefact_[] =
  {
       0,     0,     0,     0,     2,     3,     0,     4,     0,    18,
      16,    17,    15,    14,     8,    12,    13,     0,    10,     1,
       0,     5,     9,     0,     6,    11,     0,     7
  };
  ...
  parser::yytable_[] =
  {
       9,    10,    11,    12,    13,     1,    20,     2,    14,     9,
      10,    11,    12,    13,     1,     1,     2,     2,     6,    19,
       7,    21,    23,     6,    22,     4,    26,    27,     5,     0,
      25,     0,     0,     0,    24
  };
  ...
  parser::yycheck_[] =
  {
       4,     5,     6,     7,     8,     9,    14,    11,    12,     4,
       5,     6,     7,     8,     9,     9,    11,    11,     8,     0,
      10,    10,    13,     8,    12,     0,    13,    26,     0,    -1,
      23,    -1,    -1,    -1,    20
  };
  ...
  parser::yystos_[] =
  {
       0,     9,    11,    16,    17,    19,     8,    10,    18,     4,
       5,     6,     7,     8,    12,    17,    19,    20,    21,     0,
      14,    10,    12,    13,    21,    20,    13,    18
  };
  ...
  parser::yyrline_[] =
  {
       0,    74,    74,    78,    84,    87,    92,    99,   108,   111,
     116,   121,   128,   132,   136,   139,   142,   145,   148
  };
